...
public class AuthorisedPerson3 {
	private String name;
	private String sex;
	private int age;
	...
	public int elderThanMe(Person3[] resident, int totalResidents){
		int elderCount = 0;
	...
	public int oldestMale(Person3[] resident, int totalResidents){
	...
	public String getNameGivenAddress(Person3[] resident, int totalResidents, String address){
		for(int i=0; i<totalResidents; i++){
